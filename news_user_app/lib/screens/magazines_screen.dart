    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          if (docs.isEmpty) {
            return const Center(child: Text("No magazines yet."));
          }

          final width = MediaQuery.of(context).size.width;
          // Responsive columns: 2 on phones, 3 on tablets, 5 on desktop
          ...
          return GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 12,
              mainAxisSpacing: 12,
              // Portrait-like card (covers look better with this)
            ...
            itemBuilder: (context, i) {
              ...
              return _MagazineCard(
                ...
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        MagazineDetailScreen(magazineId: id, magazineName: name),
                  ),
                ),
              );
            },
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        child: Column(
          children: [
            // Keep a consistent portrait cover
            AspectRatio(
              aspectRatio: 3 / 4,
